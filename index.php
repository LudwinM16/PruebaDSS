...
<body>
        ...
        <v-simple-table class="mt-5">
            <template v-slot:default>
                ...
                <tbody>
                    ...
                    <td>
                        <v-btn fab dark color="#E53935" small @click="formEditarPATCH(empleado.id, empleado.nombre, empleado.apellidos, 
  ...
  <script>
    ...
    let url = 'http://localhost:8000/api/empleados/';
    ...
    new Vue({
      ...
      vuetify: new Vuetify(),
       ...
       methods:{          
            ...
            formEditarPATCH:function(id, nombre, apellidos, edad, salario){
              //capturamos los datos del registro seleccionado y los mostramos en el formulario
              this.empleado.id = id;
              this.empleado.nombre = nombre;                            
              this.empleado.apellidos = apellidos;
